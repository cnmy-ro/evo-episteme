...
- Positing the multiverse realizes all counter-factual possibilities that are consistent with physical theory
    - This provides concrete meaning and realness to the fundamental quantum probability functions

- Knowledge-bearing entities form a coherent structure across the multiverse
    - Knowledge is info with causal power. Therefore, a knowledge-bearing object influences the world in a determinate and consistent manner across all possible universes.
    - Large intellects, such as the Human Being, thus represent large sources of creativity in the multiverse
    - This creativity, in the fullness of time, has the potential to radically alter the structure of the multiverse

- Problems are inevitable. Yet, all problems are solvable. These two facts are sides of the same coin.
    - The inevitiability exists because of the impossibility of absolute and certain knowledge; absolute in the sense of problem-independent and certain in the sense of final truth
    - The solubility is due to an infinite potential for the growth of knowledge